...
SUPPORTED_LANGUAGES = [
    ...
    "ibo", "ind", "jav", "kin", "mar", "orm", "pcm", "ptbr", "ptmz", "ron",
    "rus", "som", "sun", "swa", "swe", "tat", "tir", "ukr", "vmw", "xho",
    "yor", "zul",
]
...
def render_details(results, missing_languages):
    ...
    for item in results:
        ...
        cards.append(
            "<table class='language-table'><tbody>"
            + "".join(metric_rows) +
            "</tbody></table>"
        )
    ...
    return (
        ...
        "<h2>SemEval 2025 Task 11 Track C Results</h2>"
        "<p>This scorer accepts one or more language prediction files named "
        "<code>pred_&lt;lang&gt;.csv</code> inside a <code>track_c</code> folder or anywhere inside the zip.</p>"
